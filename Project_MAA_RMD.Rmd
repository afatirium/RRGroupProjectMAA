...
# Create a new row for the model's results
new_row <- data.frame(Model = "AdaBoost", MAE = mae, MSE = mse, RMSE = rmse, `R2 Score` = r_squared, `RMSE_CV` = rmse_cross_val)
...
After evaluating the R2, MAE, and RMSE scores of various ML models, it was discovered that Gradient Boosting achieved the highest performance on the chosen dataset, with XGradientBoost securing the second position.
