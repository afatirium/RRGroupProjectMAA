...
After evaluating the R2, MAE, and RMSE scores of various ML models, it was discovered that XGradient Boosting achieved the highest performance on the chosen dataset, with GradientBoost securing the second position.
